...
{   //  category              name                          actor (function)              okSafeMode
    //  --------------------- ------------------------      -----------------------       ----------
    {   "custom Build",     "zs_listtransactions",       &zs_listtransactions,       true },
    {   "custom Build",     "zs_gettransaction",         &zs_gettransaction,         true },
    {   "custom Build",     "zs_listspentbyaddress",     &zs_listspentbyaddress,     true },
    {   "custom Build",     "zs_listreceivedbyaddress",  &zs_listreceivedbyaddress,  true },
    {   "custom Build",     "zs_listsentbyaddress",      &zs_listsentbyaddress,      true },
    {   "custom Build",     "getalldata",                &getalldata,                true },
};

void RegisterCustomRPCCommands(CRPCTable &tableRPC)
{
