...
extern unsigned int fDeleteInterval;
...
static const unsigned int DEFAULT_TX_DELETE_INTERVAL = 1000;
...
public:
    ...
    void AddPendingSaplingConsolidationTx(const CTransaction& tx);
