    ...
    if (mapDb[strFile] != NULL) {
      ...
      switch (result)
      {
        case DB_LOCK_DEADLOCK:
          LogPrintf("Deadlock %i\n", result);
          break;
        case DB_LOCK_NOTGRANTED:
          LogPrintf("Lock Not Granted %i\n", result);
          break;
        case DB_REP_HANDLE_DEAD:
          LogPrintf("Handle Dead %i\n", result);
          break;
        case DB_REP_LOCKOUT:
          LogPrintf("Rep Lockout %i\n", result);
          break;
        case EACCES:
          LogPrintf("Eacces %i\n", result);
          break;
        case EINVAL:
          LogPrintf("Error Invalid %i\n", result);
          break;
        case 0:
          LogPrintf("Wallet Compact Sucessful\n");
          break;
        default:
          LogPrintf("Compact result int %i\n", result);
      }
    }
    return (result == 0);
}
